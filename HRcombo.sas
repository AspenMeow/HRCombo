...
%macro assemble(hrexdt, dtfilter, ooiexdt);
 ...
 /*addtional derivation for Acad those all based on Gina SQL for Acad*/
	...
	if age>=35 and age<=39 then AR2=1; else AR2=0;
	if age>=40 and age<=44 then AR3=1; else AR3=0;
	if age>=45 and age<=49 then AR4=1; else AR4=0;
	if age>=50 and age<=54 then AR5=1; else AR5=0;
	if age>=55 and age<=59 then AR6=1; else AR6=0;
	if age>=60 and age<=64 then AR7=1; else AR7=0;
